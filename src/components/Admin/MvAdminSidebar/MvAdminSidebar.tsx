...
import { AiFillBook, AiOutlineBarChart, AiOutlineStop } from "react-icons/ai";
import {
  FiX,
  FiMenu,
  FiChevronDown,
...
export const MvAdminSidebar: React.FC<MvAdminSidebarProps> = ({
  isSidebarOpen,
  setIsSidebarOpen,
}) => {
  ...
  const navItems = [
    ...
    { icon: <FaUserCog />, label: "User Management", to: MvRoutes.ADMIN.USERS },
    {
      ...
      label: "Faculty",
      to: MvRoutes.ADMIN.FACULTY,
    },
    {
      icon: <FaStickyNote />,
      label: "Contributions",
      to: MvRoutes.ADMIN.CONTRIBUTION,
    },
    {
      icon: <FaRegCalendarAlt />,
      label: "Academic Year",
      to: MvRoutes.ADMIN.ACADEMIC_YEAR,
    },
    {
      icon: <AiOutlineStop />,
      label: "Closure Dates",
      to: MvRoutes.ADMIN.CLOSURE_DATES,
    },
    {
      icon: <FaGrinStars />,
      label: "Explore Contributions",
      to: MvRoutes.PUBLIC_CONTRIBUTION,
    },
    {
      icon: <AiOutlineBarChart />,
      label: "Most Page View",
      to: MvRoutes.ADMIN.PAGE,
    },
    {
      icon: <FaChrome />,
      ...
      <nav className="space-y-1.5">
       ...
       >
        ...
        <div className="pt-2 mt-4 border-t border-indigo-100 dark:border-gray-700">
          ...
          >
            <div className="flex items-center space-x-3">
              <FiEdit3 className="w-5 h-5 text-indigo-500 dark:text-purple-400" />
          ...
          {isDropdownOpen && (
            <div className="pl-9 mt-2 space-y-2 animate-fade-in">
              <NavLink
                to={MvRoutes.ADMIN.PROFILE_EDIT}
