...
export const MvButton: React.FC<ButtonProps> = ({ variant="primary",className, size="md",children , ...props}) => {
    ...
    const variantClasses = {
        ...
        accent: "bg-green-700 border-background-50 font-bold text-white hover:bg-accent-900 dark:text-accent-900 dark:border-background-dark-50 dark:bg-accent-dark-500 dark:hover:bg-accent-dark-300 hover:shadow-xl dark:shadow-primary-500/50",  // Accent class
     };
