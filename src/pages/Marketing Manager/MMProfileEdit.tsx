  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 right-2" onClick={(e) => e.stopPropagation()}>
        <svg
          className="w-5 h-5 text-blue-500 hover:text-blue-600 dark:text-blue-400"
          fill="currentColor"
          viewBox="0 0 20 20"
        >
      ...
      <div className="flex justify-end">
        <a
          ...
          className="flex items-center px-3 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors dark:bg-blue-600 dark:hover:bg-blue-700 text-sm"
        >
          <svg
